    ...
    >
      <div className="main-content-text">
        <h1>Using <span style={{ 
          ...
          fontStyle: 'italic',
          fontWeight: '500'
        }}> deep learning + fullstack </span> development</h1>
        <h1>to create elegant and scalable solutions to<br></br><span style={{ 
          fontFamily: 'NeueMontreal-MediumItalic, sans-serif',
          fontStyle: 'italic',
          fontWeight: '500'
      ...
      <style>{`
        ...
        /* Override global h1 styles from index.css */
        ...
        @media (max-width: 768px) {
          .main-content-container {
            ...
            min-width: 320px;
            max-width: 600px;
            top: 170px !important; /* Increased by 15px from 155px to move MainContent down further */
            margin-bottom: 0; /* Remove margin since it's not working */
          }
        ...
        @media (max-width: 480px) {
          .main-content-container {
            ...
            min-width: 300px;
            max-width: 400px;
            top: 150px !important; /* Increased by 15px from 135px to move MainContent down further */
            margin-bottom: 0; /* Remove margin since it's not working */
          }
        }
        ...
        @media (max-width: 457px) {
          .main-content-container {
            top: 130px !important; /* Increased by 15px from 115px to move MainContent down further */
            margin-bottom: 0; /* Remove margin since it's not working */
          }
        }
